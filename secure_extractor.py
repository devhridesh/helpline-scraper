...
# ==============================================================================
print("DEBUG: Starting Script Initialization...")
...
def check_time_guardrail():
    if IS_GITHUB:
        ...
        if ist_now < target_time:
            ...
            sys.exit(0)
    print("DEBUG: Time Guardrail Passed.")

# ==============================================================================
# 2. MASTER LIST (Full 60+ Companies)
# ==============================================================================
TARGET_COMPANIES = [
...
def process_single_company(company):
    ...
    # AI Mapping
    print(f"DEBUG: Attempting AI mapping for {company['name']}")
    try:
        ...
        print("DEBUG: AI mapping success")
